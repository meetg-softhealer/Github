...
class ShDoctorCommission(models.Model):
    ...
    sh_so_amount = fields.Monetary("Total Amount", currency_field='sh_company_currency_id',required=True)
    ...
    sh_total_commission = fields.Monetary(string="Dr.Commission", currency_field='sh_company_currency_id', required=True)
